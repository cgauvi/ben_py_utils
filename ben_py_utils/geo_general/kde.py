...
def convert_2D_kernel_polygon(xx, yy, kern_dens_2d):
    # For contour conversion to Polygon + value extracion: https://gis.stackexchange.com/questions/99917/converting-matplotlib-contour-objects-to-shapely-objects
