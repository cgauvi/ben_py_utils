"""Author LouisdeBruijn

https://github.com/LouisdeBruijn/Medium/
...
from ben_py_utils.misc.constants import ROOT_PROJECT
...
def main():
    ...
    dir_to_use = Path(ROOT_PROJECT)

    docstring_from_type_hints(dir_to_use, overwrite_script=True, test=False)
